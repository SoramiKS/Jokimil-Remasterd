  ...
  return (
    <div className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('/img/home.jpg')] bg-cover bg-center opacity-20"></div>
            ...
            <div className="pt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
              {stats.map((stat, index) => (
                <div key={index} className="text-center">
                  <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-dark-blue-500 to-dark-red-500 bg-clip-text text-transparent mb-2 notranslate">
                    {stat.number}
                  </div>
