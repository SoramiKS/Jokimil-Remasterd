        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a 
                href="https://wa.me/1234567890?text=Hi! I have a question about your boosting service."
                target="_blank"
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="text-gray-400 text-sm">Map Unlocking - $15</div>
              <div className="text-gray-400 text-sm">Echo Farming - $20</div>
              <div className="text-gray-400 text-sm">Main Quest Completion - $25</div>
              <div className="text-gray-400 text-sm">Weekly Boss Runs - $12</div>
              <div className="text-gray-400 text-sm">Live Stream Option - +$10</div>
            </div>
          </div>
        ...
        <div className="border-t border-red-900/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm">
              <a 
                href="https://wa.me/1234567890?text=Hi! I'd like to know about your privacy policy."
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a 
                href="https://wa.me/1234567890?text=Hi! I'd like to know about your terms of service."
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-red-400 transition-colors"
              >
              ...
              <a 
                href="https://wa.me/1234567890?text=Hi! I'd like to know about your refund policy."
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-red-400 transition-colors"
              >
